    ...
    <main className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-surface border-b border-border">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-sm font-medium text-foreground-muted hover:text-primary transition-colors">Features</a>
            <a href="#how-it-works" className="text-sm font-medium text-foreground-muted hover:text-primary transition-colors">How it Works</a>
            <a href="#ai-architecture" className="text-sm font-medium text-foreground-muted hover:text-primary transition-colors">Technology</a>
            <Link href="/login">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-light text-primary border border-primary-border mb-8">
          ...
          <p className="text-xl md:text-2xl text-foreground-muted mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button className="w-full sm:w-auto px-8 py-3.5 bg-surface text-foreground-muted border border-border-strong text-lg font-semibold rounded-lg hover:bg-background transition-all">
              Watch 2-min Demo
            </button>
          </div>
      ...
      <section id="features" className="py-32 px-6 bg-surface">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[600px]">
            {/* Large Left Card */}
            <div className="md:col-span-2 md:row-span-2 bg-surface border border-border rounded-[2rem] p-10 flex flex-col justify-between relative overflow-hidden group hover:border-primary/20 transition-all duration-500 shadow-sm">
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-surface shadow-sm flex items-center justify-center mb-6 text-2xl">
                  ⚡
                </div>
              ...
              <div className="absolute right-0 bottom-0 w-2/3 h-2/3 bg-surface rounded-tl-[2.5rem] shadow-2xl border-t border-l border-slate-100 p-6 translate-x-10 translate-y-10 group-hover:translate-x-6 group-hover:translate-y-6 transition-transform duration-500">
            ...
            <div className="bg-gray-900 rounded-[2rem] p-10 text-white flex flex-col justify-center relative overflow-hidden hover:scale-[1.02] transition-transform duration-300 shadow-lg">
              ...
              <p className="text-foreground-muted">Respects availability, preferred rooms, and load balancing automatically.</p>
            </div>

            {/* Bottom Right Card */}
            <div className="bg-primary-light border border-primary-border rounded-[2rem] p-10 flex flex-col justify-center relative overflow-hidden hover:scale-[1.02] transition-transform duration-300">
              <PieChart className="w-10 h-10 text-primary mb-6" />
              <h3 className="text-2xl font-bold mb-2 text-foreground">Analytics Ready</h3>
              <p className="text-primary/80">Visual insights into room usage, teacher gaps, and class distribution.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-32 px-6 bg-surface border-t border-border">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">From Stress to Success</h2>
            <p className="text-xl text-foreground-muted">Three simple steps to your new schedule.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-light text-primary text-sm font-semibold mb-6">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    <div className="w-12 h-12 rounded-xl bg-primary-light flex items-center justify-center flex-shrink-0 text-primary">
            ...
            <div className="flex-1 relative">
              ...
              <div className="relative z-10 bg-slate-900 rounded-3xl p-8 border border-slate-800 shadow-2xl">
                ...
                <div className="space-y-4 font-mono text-sm">
                  <div className="flex justify-between text-slate-400">
                    ...
                    <span className="text-success">Done (0.4s)</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>&gt; Checking room conflicts...</span>
                    <span className="text-success">0 found</span>
                  </div>
                  <div className="flex justify-between text-slate-400">
                    <span>&gt; Optimizing teacher gaps...</span>
                    <span className="text-primary/60 animate-pulse">Processing...</span>
                  </div>
              ...
              <div className="absolute -top-10 -right-10 w-40 h-40 bg-primary/20 blur-2xl rounded-full animate-pulse"></div>
              <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-primary/20 blur-2xl rounded-full animate-pulse delay-1000"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-surface border-t border-border text-foreground-muted py-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-center md:text-left">
            <div className="text-2xl font-bold text-foreground mb-2">Schedool</div>
