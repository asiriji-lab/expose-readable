...
import { STUDENT_VALIDATION_RULES } from '../validationUtils';
import { useCsvStep } from '../hooks/useCsvStep';

/**
 * Step 6: Student Data Upload
 * 
 * Handles uploading and validation of student data.
 * Uses useCsvStep hook for shared logic.
 */
import { StepProps } from '../../_types';

export function Step6_Student({ data, onChange, errors }: StepProps) {
    const {
        isEditing,
        setIsEditing,
        validationErrors,
        ...
        onFileChange: (file) => onChange('studentFile', file),
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
                ...
                <a href="/example_csv/example_student.csv" download className="text-sm text-blue-600 hover:underline flex items-center gap-2">
