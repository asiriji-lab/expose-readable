...
import { CONSTRAINT_VALIDATION_RULES } from '../validationUtils';
import { useCsvStep } from '../hooks/useCsvStep';

/**
 * Step 8: Constraint Data Upload
 * 
...
export function Step8_Constraint({ data, onChange, errors }: StepProps) {
    const {
        ...
        onFileChange: (file) => onChange('constraintFile', file),
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
                ...
                <a href="/example_csv/example_constraint.csv" download className="text-sm text-blue-600 hover:underline flex items-center gap-2">
