...
export function Step7_Room({ data, onChange, errors }: StepProps) {
    const {
        isEditing,
        setIsEditing,
        validationErrors,
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
                ...
                <a href="/example_csv/example_room.csv" download className="text-sm text-blue-600 hover:underline flex items-center gap-2">
